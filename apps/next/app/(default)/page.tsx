    ...
    <Grid paddingVertical="2x-large" gapVertical="2x-large">
        ...
        <DevNote
          note={
            <>
              ...
              <ComponentReference label="Link" npmPackage="@nl-design-system-candidate/link-react" />
        ...
        <DevNote
          note={
            <>
              ...
              <ComponentReference label="Note" npmPackage="@utrecht/note-react" />
            </>
          }
          title="Which component should you use?"
        >
      ...
      <GridCell span={contentSpan}>
        <DevNote
          ...
          title="Installing your first component"
        >
        ...
        <DevNote
          note={
            <>
              <ComponentReference label="Heading" npmPackage="@nl-design-system-candidate/heading-react" />
              <ComponentReference label="Paragraph" npmPackage="@nl-design-system-candidate/paragraph-react" />
              <ComponentReference label="LinkList" npmPackage="@amsterdam/design-system-react" />
            </>
          }
          title="Next steps"
        >
