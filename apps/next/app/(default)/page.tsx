    ...
    <Grid paddingVertical="2x-large" gapVertical="2x-large">
      ...
      <GridCell span={contentSpan}>
        ...
        <Paragraph>
          ...
          components, share them with the community, and together help them mature into Candidate and, eventually, Hall
          of Fame status. Using a component is often the first step toward contributing one.
        </Paragraph>
        <Paragraph>
          This project shows how you can discover and use components from the NL Design System in a Next.js application
          and doubles as a starting point if you want to build a component of your own.
        </Paragraph>
        <Paragraph>
      ...
      <GridCell span={contentSpan}>
        ...
        <Paragraph>
          ...
          <Link href="https://nldesignsystem.nl/handboek/estafettemodel/">estafettemodel</Link> (relay model). It ranges
          from a documented need with no implementation yet, to a production-proven implementation used across
          organisations:
        </Paragraph>
        <OrderedList>
          <OrderedListItem>
          ...
          <OrderedListItem>
            <Paragraph>
              <strong>Community</strong> built by the community according to NL Design System guidelines and usable with
              confidence. It can contain community specific quirks.
            </Paragraph>
          </OrderedListItem>
          <OrderedListItem>
            <Paragraph>
          ...
          <OrderedListItem>
            <Paragraph>
              <strong>Hall of Fame</strong> used in production by at least two organizations, audited for accessibility,
              and semantically versioned with a changelog.
            </Paragraph>
          </OrderedListItem>
          <OrderedListItem>
            <Paragraph>
        ...
        <Note purpose="info">
          <Paragraph>
            Rule of thumb: if a mature (Hall of Fame or Candidate) component already exists for your use case, reach for
            that first. If it doesn't exist yet, or it doesn't fit your needs, create your own — share it with the
        ...
        <OrderedList>
          ...
          <OrderedListItem>
            <Paragraph>
              ...
              <Code>@nl-design-system-unstable/start-design-tokens</Code> and applies the <Code>start-theme</Code> class
              in <Code>app/layout.tsx</Code>.
            </Paragraph>
            <CodeBlock>
            ...
            <Alert type="warning">
              <Paragraph>
                ...
                means you need to assign these yourself. Generally it's best to do this in a single css file to have all
                the custom variables in a single location.
              </Paragraph>
            </Alert>
          </OrderedListItem>
          <OrderedListItem>
            ...
            <Paragraph>
              The React components can also be imported with CSS included but with the caveat that it can only be client
              side rendered:
            </Paragraph>
